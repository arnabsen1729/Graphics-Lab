...
public class DrawShape2 {
  ...
  public static void main(String[] args) {
    DrawShape2 coord = new DrawShape2();
  }
  ...
  private void prepareGUI() {
    ...
    mainFrame = new JFrame("Assignment 3 - Q3. Shape 2 Arnab Sen (510519006)");
  ...
  class GridCanvas extends Canvas {
    ...
    public void paint(Graphics g) {
      ...
      lines.add(new Line(new Point(7, 9), new Point(11, 20)));
      lines.add(new Line(new Point(11, 8), new Point(20, 17)));
      lines.add(new Line(new Point(16, 7), new Point(27, 15)));
      lines.add(new Line(new Point(23, 4), new Point(35, 8)));

      lines.add(new Line(new Point(-7, 9), new Point(-10, 20)));
      lines.add(new Line(new Point(-11, 8), new Point(-22, 17)));
      lines.add(new Line(new Point(-16, 7), new Point(-25, 15)));
      lines.add(new Line(new Point(-23, 4), new Point(-37, 8)));

      lines.add(new Line(new Point(7, -9), new Point(13, -20)));
      lines.add(new Line(new Point(11, -8), new Point(21, -17)));
      lines.add(new Line(new Point(16, -7), new Point(26, -15)));
      lines.add(new Line(new Point(23, -4), new Point(34, -8)));

      lines.add(new Line(new Point(-7, -9), new Point(-9, -20)));
      lines.add(new Line(new Point(-11, -8), new Point(-23, -17)));
      lines.add(new Line(new Point(-16, -7), new Point(-28, -15)));
      lines.add(new Line(new Point(-23, -4), new Point(-36, -8)));
